...
def translate_text(**kwargs):
    ...
    # Print only the TranslatedText output
...
if __name__ == "__main__":
    main()
#  & c:/code/MachineLearning/ML-Study-Repo/.venv/Scripts/python.exe c:/code/MachineLearning/AWS-python-workshop/lab_5_step_2_cli_arguments.py  --text "Hello, world!" --source-language-code "en" --target-language-code "es"
